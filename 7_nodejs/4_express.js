/*
    ...
    EJS
    - EJS(Embedded JavaScript)는 HTML 안에 JavaScript 코드를 삽입해 서버 데이터를 동적으로 렌더린할 수 있게 해주는 node.js용 쳄플릿 엔진
    - <%= %>, <% %> 안에서 로직을 작성하여 사용
    ...
    - 서버에서 전달한 값을 HTML안에 삽입해 최종 페이지를 생성하며, 반복문/조건문 같은 로직도 템플릿 내부에서 처리할 수 있음

*/
// 파이썬에서 import 하는거랑 같은 느낌
...
// http://127.0.0.1:3000/static/spring.png
app.use("/static",express.static('public'))
// post 데이터 전송한걸 받을수 있게 함
